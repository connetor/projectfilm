<?php
    ...
    $type = $_GET['type'];
    $typeid=$_GET['type'];
    $sql = "SELECT `Worker_ID`,`ProfilePic`, `Fname`, `Lname`, `TypeID`, `Extention` FROM `workerinformation` WHERE `TypeID` = ".$type;
            ...
            <div class="row">
                <div class="col-md-3 wow fadeInLeft delay-05s">
                    <div class="section-title">
                        <h2 class="head-title">ช่าง <?php echo $obj->type_select($type); $type=$obj->type_select($type)?></h2>
                        <hr class="botm-line">
                ...
                <div class="col-md-9">
                    <div class="row">
                         <?php
                            ...
                            <div class="">
                                <center>
                                    <img src="worker-form/html/'.$_data['ProfilePic'].'" height="100" width="100" alt="" class="img-responsive">
                                </center>
                            </div>
                            <div class="icon-text">
                                <h3 class="txt-tl">
                                    <a href="technician.php?id='.$_data['Worker_ID'].'&type='.$typeid.'">งาน : '.$obj->type_select($_data['TypeID']).'</a>
                                </h3>
