...
<body class="fix-header">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="showstdjob.php" class="waves-effect">
                            <i class="fa fa-globe fa-fw" aria-hidden="true"></i>เพิ่มงานพื้นฐาน</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () { 
            var id = 2;
          $.ajax({
            url:'data_workerinformation.php',
            type:'post',
            data:{data:true},
            success:function(res){
                $('#show_worker').load('data_workerinformation.php?data='+id);
            }
          });        
