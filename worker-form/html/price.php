            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Promotion/News Page</h4>
                    </div>
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">จำนวนเงินที่ยังค้าง</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" disabled name="name" value="10,000"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">จำนวนเงินที่สามารถเบิกได้</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" disabled name="name" value="10,000"> </div>
                                </div>
                                <div class="form-group">
                                        <label class="col-md-12">จำนวนเงินที่ต้องการเบิก</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control form-control-line" name="name" value="0.00"> </div>
                                    </div>
                                <button class="btn btn-success">เบิกเงิน</button>
