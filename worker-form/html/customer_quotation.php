                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                            ...
                            <div class="user-bg">
                                ...
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <h4 class="text-white"><?php echo $obj->return_member($data['Member_ID']); ?></h4>
                                        <h5 class="text-white">เคยจ้างงานจำนวน .... ครั้ง</h5>
                                    </div>
                                </div>
                            </div>

                        </div>
                        <a style="<?php  if ($data['IsConfirmRequest']!=NULL) {
                                echo 'display: none;';
                            }  ?>" class="btn btn-success" href="quotation_confirm.php?id_request=<?php echo $_GET['id_request']; ?>">ยืนยัน</a>
                        <?php
                           

                            if ($data['IsConfirmRequest']==NULL) {
                                echo '<button class="btn btn-danger" onclick="uncomfirm()" >ยกเลิก</button>';
                            }
                        ?>
                        ...
                        <?php
                            ...
                            if($data['IsConfirmRequest']==NULL){
                                echo "รอยืนยันคำขอลูกค้า";
                            }
                            else if ($data['IsConfirmRequest']==0) {
                                echo "ปฏิเสธคำขอลูกค้า";
                            }
                            if($ISConfirmQuo['ISConfirm']==1&&$check!=0){
                                echo "ยืนยันใบเสนอราคาแล้ว";
                            }else if($ISConfirmQuo['ISConfirm']==NULL&&$check!=0){
                                echo "รอยืนยันใบเสนอราคา";
                            }                        
                            else if($ISConfirmQuo['ISConfirm']==0&&$check!=0){
                                echo "ลูกค้าปฏิเสธใบเสนอราคา";
                            }
    ...
    <script type="text/javascript">
        function uncomfirm(){
            $.ajax({
                url:'uncon.php',
                type:'post',
                data:{data:<?php echo $_GET['id_request']; ?>},
